...
double calcula(Categoria categoria, double a, double b)
{
...
void mostraPilha(double v[MAX_TAMANHO], int j)
{
    int i;
    j--;
 ...
 * uma expressao em notacao 3 4posfixa. 
 *
...
eval (CelObjeto *iniPosfixa, Bool mostrePilhaExecucao)
{
    ...
    Stack *iniPilha1, *iniPilha2, pilha1;
